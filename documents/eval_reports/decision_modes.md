...
| --- | --- | --- |
| Stops scored | 203 of 573 (35.4%) | real green-flag stops the tier could grade |
| Exact lap | 18.7% | chose the lap the team chose |
| Within 1 lap | 34.0% | same call, one lap either side |
| Within 2 laps | 49.8% | same strategic window |
...
| Mean absolute error | 2.49 laps | magnitude, same width caveat |
