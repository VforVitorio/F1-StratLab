...
<div class="stratlab-hero" markdown>
  ...
  <p>An end-to-end tour of the codebase: how a single lap-tick travels from the replay engine through the six sub-agents, into the N31 orchestrator and out to the operator surfaces. Use this page as the entry point, then drill into the deeper references below.</p>
</div>
...
sequenceDiagram
    ...
    Subs-->>Orch: structured outputs (Pace, Tire, Race Sit., Pit, Radio, RAG)
...
<div class="stratlab-stack-grid" markdown>
  ...
  <span class="stratlab-stack-eyebrow">Deep dive</span>
  ### Architecture overview
  The full annotated diagram, the layer-by-layer breakdown of `src/`, and the rationale behind every contract on the wire.
  [Read the overview](../architecture.md)
  </div>
  <div class="stratlab-stack-card" markdown>
  <span class="stratlab-stack-eyebrow">Runtime</span>
  ### Simulation engine
  The replay engine that drives development. Covers `RaceReplayEngine`, `RaceStateManager`, the lap-loop and the `lap_state` schema every layer agrees on.
  [Read the simulation guide](../simulation/overview.md)
  </div>
  <div class="stratlab-stack-card" markdown>
  <span class="stratlab-stack-eyebrow">Agents</span>
  ### Multi-agent API
  Per-agent input / output schemas, model artefacts and entry-point signatures. The reference for embedding the agents in your own pipelines.
  [Open the API reference](../agents-api-reference.md)
  </div>
  <div class="stratlab-stack-card" markdown>
  <span class="stratlab-stack-eyebrow">Service</span>
  ### Backend API
  FastAPI routers, the SSE simulation endpoint, CORS expectations and the contract used by Streamlit and the Arcade.
  [Read the backend API](../backend-api.md)
  </div>
  <div class="stratlab-stack-card" markdown>
  <span class="stratlab-stack-eyebrow">Surface</span>
  ### Streamlit frontend
  Tab-by-tab walkthrough of the Streamlit app — race analysis, chat with charts, MCP integration and the voice upgrade.
  [Read the frontend guide](../streamlit-frontend.md)
  </div>
  <div class="stratlab-stack-card" markdown>
  <span class="stratlab-stack-eyebrow">Surface</span>
  ### Arcade dashboard
  Three independent windows (replay viewer · strategy dashboard · live telemetry) coordinated by a single Python process.
  [Open the arcade quick-start](../arcade/quick-start.md)
  </div>
</div>

<div class="stratlab-callout" markdown>
  <span class="stratlab-callout-eyebrow">DeepWiki</span>
...
See [Setup and deployment](../setup-and-deployment.md) for the full install matrix per surface and platform.
